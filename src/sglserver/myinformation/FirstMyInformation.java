...
public class FirstMyInformation {
	 ...
	 */
	public FirstMyInformation(String id){
	 ...
	 * @author kinbara
	 */
	public void addUser(String UserID , String Name,String mailad){
		try{
			...
			uId.appendChild(document.createTextNode(UserID));
			...
			String cert = "src/sglclient/conf/usr/ca/"+Name+".cer";
